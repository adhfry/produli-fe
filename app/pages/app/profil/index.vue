...
<template>
  ...
  <div class="p-5">
     ...
     <div class="bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-sm border border-slate-100 dark:border-slate-700 mb-6 flex flex-col items-center text-center transition-colors duration-300">
        <div class="w-24 h-24 bg-primary/10 rounded-full flex items-center justify-center border-4 border-primary/20 shadow-sm mb-4 transition-colors relative">
           <span class="text-primary font-black text-3xl">SA</span>
           <div class="absolute bottom-0 right-0 w-6 h-6 bg-warning rounded-full border-2 border-white dark:border-slate-800 flex items-center justify-center transition-colors">
              <LucideAlertCircle class="w-3.5 h-3.5 text-white" />
           </div>
        </div>
        <h2 class="text-xl font-black text-slate-800 dark:text-white mb-1 transition-colors">Siti Aminah</h2>
        <p class="text-base text-slate-500 dark:text-slate-400 font-medium transition-colors">Kader Prolanis &bull; Puskesmas Pamolokan</p>
     </div>
     
     <!-- Google Link Warning -->
     <div class="bg-warning/10 dark:bg-warning/5 border border-warning/20 dark:border-warning/10 rounded-3xl p-5 mb-6 flex flex-col gap-4 shadow-sm transition-colors duration-300">
        ...
        <button class="w-full py-3 bg-white dark:bg-slate-800 border border-warning/30 dark:border-warning/20 text-warning-600 dark:text-warning-400 font-bold text-base uppercase tracking-wider rounded-xl shadow-sm active:scale-[0.98] transition-all">
           Tautkan Sekarang
        </button>
     </div>
     ...
     <div class="bg-white dark:bg-slate-800 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden mb-6 transition-colors duration-300">
        ...
        <NuxtLink to="/app/profil/keamanan" class="w-full flex items-center justify-between p-4 active:bg-slate-50 dark:active:bg-slate-700 transition-colors">
           <div class="flex items-center gap-3">
